...
| Часть I, Глава 3 | book/01-Part-I/03-How-Process-Changed.md | ✅ Draft (финальная) |
---
...
|---|---|---|
| Предисловие | — | Stub |
| **Глава 1** | **Последний инструмент, который вам придётся изучить** | **✅ Draft (финальная)** |
| **Глава 2** | **Что такое Vibe Coding** | **✅ Draft (финальная)** |
| **Глава 3** | **Как изменился процесс разработки** | **✅ Draft (финальная)** |
| Глава 4 | Роль разработчика в эпоху ИИ | Не начата |
| Глава 5 | Новый цикл создания продуктов | Не начата |
